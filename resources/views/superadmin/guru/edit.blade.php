...
<div class="p-8">
    <div class="max-w-5xl mx-auto">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h2 class="text-3xl font-bold text-white mb-1">Edit Data Guru</h2>
                <p class="text-sm text-gray-400">Memperbarui informasi untuk: <span class="text-indigo-400 font-medium">{{ $guru->nama }}</span></p>
            </div>
        </div>
                    ...
                    <div class="bg-[#1e243b] border border-slate-600 rounded-xl p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="nomor_induk" value="{{ old('nomor_induk', $guru->nomor_induk) }}" required
                            ...
                            <div>
                                ...
                                <div class="flex gap-4">
                                    <label class="flex items-center gap-2 text-gray-300 cursor-pointer">
                                        <input type="radio" name="jenis_kelamin" value="L" {{ old('jenis_kelamin', $guru->jenis_kelamin) == 'L' ? 'checked' : '' }} class="text-indigo-600 bg-[#111827] border-slate-600"> Laki-laki
                                    </label>
                                    <label class="flex items-center gap-2 text-gray-300 cursor-pointer">
                                        <input type="radio" name="jenis_kelamin" value="P" {{ old('jenis_kelamin', $guru->jenis_kelamin) == 'P' ? 'checked' : '' }} class="text-indigo-600 bg-[#111827] border-slate-600"> Perempuan
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-[#1e243b] border border-slate-600 rounded-xl p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-1">Hanya isi jika ingin mereset password guru.</p>
