...
<div class="p-8">
    <div class="max-w-5xl mx-auto">
        ...
        <div class="flex items-center gap-4 mb-8">
            <a href="{{ route('superadmin.guru') }}" class="p-2 bg-[#1e243b] hover:bg-slate-700 border border-slate-600 rounded-lg text-gray-400 hover:text-white transition">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
            </a>
            <div>
                <h2 class="text-3xl font-bold text-white mb-1">Tambah Guru Baru</h2>
                <p class="text-sm text-gray-400">Masukkan identitas dan kredensial login untuk Guru.</p>
            </div>
        </div>
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="bg-[#1e243b] border border-slate-600 rounded-xl p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <!-- Input NISN -->
                            <div>
                                <label class="block text-sm font-medium text-gray-300 mb-1">NIG / Nomor Induk <span class="text-red-500">*</span></label>
        ...
        <button onclick="openModal('modal-import-guru')"
...
<!-- MODAL IMPORT EXCEL -->
<!-- ========================================== -->
<div id="modal-import-guru" class="hidden fixed inset-0 z-50 flex items-center justify-center overflow-y-auto overflow-x-hidden bg-black/60 backdrop-blur-sm transition-opacity duration-300">
    <div class="relative w-full max-w-md p-4 animate-fade-in-up">
        <div class="relative bg-[#1e243b] border border-slate-600 rounded-2xl shadow-2xl">
            <div class="flex items-center justify-between p-5 border-b border-slate-600/60 rounded-t-2xl">
                <h3 class="text-xl font-bold text-white">Import Data Guru</h3>
                <button type="button" onclick="closeModal('modal-import-guru')" class="text-gray-400 bg-transparent hover:bg-slate-700 hover:text-white rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center">
            ...
            <form action="{{ route('superadmin.guru.import') }}" method="POST" enctype="multipart/form-data" class="p-5">
                @csrf
                <div class="space-y-4">
                ...
                <div class="flex items-center justify-end gap-3 mt-6 pt-5 border-t border-slate-600/60">
                    <button type="button" onclick="closeModal('modal-import-guru')" class="text-gray-300 hover:bg-slate-700 rounded-lg text-sm px-5 py-2.5">Batal</button>
