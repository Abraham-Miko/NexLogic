    ...
    <main class="flex-1 flex flex-col max-h-screen">
        ...
        <div class="flex-1 overflow-y-auto p-8">
            <div class="max-w-7xl mx-auto space-y-8">
                ...
                <!-- Header -->
                <div>
                    <h2 class="text-3xl font-bold text-white mb-2">Manajemen Akun Siswa</h2>
                    <p class="text-gray-400">Manajemen dan monitoring Siswa</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="bg-[#1e243b] border border-slate-600 rounded-xl p-5 relative overflow-hidden">
                        ...
                        <div class="flex items-end gap-3">
                            <span class="text-4xl font-bold text-white">{{ $totalSiswa }}</span>
                            {{-- <span class="text-xs font-medium text-white-400 px-2 py-0.5 rounded flex items-center mb-1">orang</span> --}}
                        </div>
                    ...
                    <div class="bg-[#1e243b] border border-slate-600 rounded-xl p-5">
                        ...
                        <div class="flex items-end gap-3">
                            <span class="text-4xl font-bold text-white">{{ $siswaAktif }}</span>
                    ...
                    <div class="bg-[#1e243b] border border-slate-600 rounded-xl p-5">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h3 class="text-sm font-medium text-gray-300">Siswa Tidak Aktif</h3>
                        </div>
                        <div class="flex items-end gap-3">
                            <span class="text-4xl font-bold text-white">{{ $siswaTidakAktif }}</span>
                    ...
                    <div class="bg-[#1e243b] border border-slate-600 rounded-xl p-5">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <h3 class="text-sm font-medium text-gray-300">Akun Dibuat</h3>
                        </div>
                        <div class="flex items-end gap-3">
                            <span class="text-4xl font-bold text-white">{{ $siswaBaru }}</span>
                        </div>
                        {{-- <p class="text-xs text-gray-500 mt-2">This semester</p> --}}
                    </div>
                </div>
                ...
                <!-- Filters & Search -->
                    <form method="GET" action="{{ route('superadmin.siswa') }}" class="flex flex-wrap items-center gap-3 w-full md:w-auto">
                        ...
                        @if(request('search') || request('jenis_kelamin') || request('status'))
                            <a href="{{ route('superadmin.siswa') }}" class="text-sm text-red-400 hover:text-red-300 px-2 py-2 flex items-center gap-1 transition">
                            ...
                            <tr class="hover:bg-slate-800/30 transition">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-3">
                                        ...
                                        <!-- Tombol Edit -->
                                        <a href="{{ route('superadmin.siswa.edit', $data->id) }}" class="text-gray-400 hover:text-indigo-400 transition" title="Edit">
                            ...
                            <tr>
                                ...
                                <td colspan="8" class="px-6 py-16 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <!-- Teks Informasi -->
                                        <h3 class="text-lg font-medium text-white mb-1 font-heading">Belum Ada Data Siswa</h3>
                                        <p class="text-sm text-gray-400 max-w-sm mx-auto mb-6">
                                            Saat ini belum ada data siswa yang terdaftar di dalam sistem. Anda bisa menambahkannya secara manual atau mengimpor data.
                                        </p>
                                    </div>
                                </td>
                            </tr>
...
<script>
    ...
    function confirmDelete(id, studentName) {
        Swal.fire({
            ...
            html: "Data siswa <span class='font-bold text-indigo-400'>" + studentName + "</span> akan dihapus secara permanen dan tidak dapat dikembalikan!",
            icon: 'warning',
