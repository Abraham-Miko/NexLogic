                ...
                <div class="footer-grid">
                    ...
                    <div>
                        ...
                        <div style="display: flex; flex-direction: column;">
                            <a href="{{ route('/') }}" class="footer-link">Home</a>
                            <a href="{{ route('courses') }}" class="footer-link">Courses</a>
                            <a href="{{ route('puzzle.index') }}" class="footer-link">Puzzle</a>
                            <a href="{{ route('leaderboard.index') }}" class="footer-link">Leaderboard</a>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div style="display: flex; flex-direction: column; margin-bottom: 24px;">
                            ...
                            <a href="https://github.com/Abraham-Miko/NexLogic" class="footer-link">GitHub</a>
                        </div>

                        <div style="display: flex; gap: 20px;">
                            {{-- GitHub Icon --}}
                            <a href="https://github.com/Abraham-Miko/NexLogic" style="color: #fff; transition: color 0.2s ease;" onmouseover="this.style.color='#22d3ee'" onmouseout="this.style.color='#fff'">
